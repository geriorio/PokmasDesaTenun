...
@section('content')
    <div class="flex flex-col w-full py-8 rounded-lg shadow-xl items-center justify-center mb-10">
        <h1 class="text-center text-4xl uppercase font-bold mb-2">Kategori Barang</h1>
    </div>
        ...
        <div class="w-full flex flex-col items-end mb-3 px-8 pt-5">
            <div>
                <button
                    ...
                    data-te-toggle="modal" data-te-target="#Modal">Add kategori Barang</button>
            </div>
...
@section('script')
    <script>
        ...
        var data = JSON.parse(@json($kategori));
                        ...
                        detail: `
                            <div class="flex" id="action-buttons-${item.id}">
                                ...
                                <button onclick='cancel(${JSON.stringify(item.id)})' data-te-ripple-init data-te-ripple-color="light"
                                    class="mr-3 btn-detail block mb-2 rounded bg-success px-6 pb-2 pt-2.5 text-xs text-center font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]" style="display:none;">
                                    Cancel
                                </button>
                                <button onclick='updateKategori(${JSON.stringify(item.id)})' data-te-ripple-init data-te-ripple-color="light"
                                    class="mr-3 btn-detail block mb-2 rounded bg-success px-6 pb-2 pt-2.5 text-xs text-center font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]">
                                    Update
                                </button>
                            </div>
        ...
        function save(id) {
            ...
            var url_update = "{{ route('kategori.update', ':id') }}".replace(':id', id);
            $.ajax({
                url: url_update,
                type: 'PUT',
                data: {
                    ...
                    $.ajax({
                        ...
                        success: async function(response) {
                            if (response.success) {
                                ...
                                window.location.href = "{{ route('viewKategori') }}";
                            } else {
                                await Swal.fire({
                                    icon: 'error',
                                    title: 'Error',
